package com.github.javaservergroup.apiclient.demo;

import com.github.javaservergroup.apiclient.demo.model.People;
import com.github.javaservergroup.apiclient.demo.model.ResponsePeople;
...
import static com.github.javaservergroup.apiclient.ApiClient.Api;
...
public class ApiClientTest {
    ...
    @Test(expected = RestPostNotSupportFileException.class)
    ...
    public void get404() throws Exception {
        Api().post("http://www.example.org/404");
    }
    ...
    @Test
    public void testHeader() throws IOException, StatusCodeNot200Exception {
    ...
    @Test
    public void testRedirect() throws IOException, StatusCodeNot200Exception {
        assertEquals("ok", Api().get(host + "/forTestRedirect"));
    }

    @Test
    public void testHead() throws IOException, StatusCodeNot200Exception {
    ...
    @Test
    public void testZip() throws IOException, StatusCodeNot200Exception {
        assertEquals("get Gzip com.github.javaservergroup.apiclient.demo.controller", Api().get(host + "/getGzip"));
    }
